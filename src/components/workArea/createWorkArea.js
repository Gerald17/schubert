...
const CreateWorkArea = ({
	...
	const handleSubmit = e => {
		...
		validateFields((err, values) => {
			if (!err) {
				request
					.createData(`${endpoints.workArea}`, values)
					.then(response => {
...
const EnhancedCreateWorkAreaForm = Form.create({ name: 'workArea_create' })(
	CreateWorkArea
);

export default connect(mapStateToProps, {})(EnhancedCreateWorkAreaForm);
